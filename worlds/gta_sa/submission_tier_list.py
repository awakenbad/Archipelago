...
SUBMISSION_TIERS = [
    ...
    SubmissionTier(96, 8,  "Trucking",    "Level {tier}",   1, "Badlands",   33,
                   option_attr="trucking_checks", zero_disables=True),
    ...
    SubmissionTier(200, 18, "Bike School", "{name}",        0, "Las Venturas", 39,
                   logic_region="San Fierro",
                   tier_names=medal_tiers(BIKE_SCHOOL_TESTS), medals_per_test=3),
    SubmissionTier(218, 7, "Quarry",      "Mission {tier}", 1, "Las Venturas", 65,
                   option_attr="quarry_checks", zero_disables=True),
    ...
    SubmissionTier(249, 4, "Courier", "Hippy Shopper Level {tier}", 1, "San Fierro", 0,
                   logic_region="Los Santos",
                   option_attr="courier_checks", zero_disables=True),
    SubmissionTier(253, 4, "Courier", "Burger Shot Level {tier}", 1, "Las Venturas", 0,
                   logic_region="Los Santos",
                   option_attr="courier_checks", zero_disables=True),
    ...
    SubmissionTier(284, 1, "Shooting Range", "{name}",      3, "Los Santos", 27,
                   tier_names=SHOOTING_RANGE_WEAPONS[2:3], requires_option="include_shooting_range"),
    SubmissionTier(285, 1, "Shooting Range", "{name}",      3, "Los Santos", 54,
